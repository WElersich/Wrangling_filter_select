...
animation_comedy <- movies %>%
  filter(votes > 100, !Animation == 0, !Comedy == 0) %>%
    select(title, votes, budget) %>%
      arrange(desc(budget))
  
animation_comedy
```
The highest budget of any animation or comedy belongs to *Monsters, inc.* with a budget of 115 million dollars ($115000000).
